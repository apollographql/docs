...
After you [create a cloud supergraph](../getting-started/), you can view and manage its router's configuration from Apollo Studio. Go to the **Settings** page for your variant in Studio, then click the **Cloud Routing** tab:
...
- Your router's current status and [launch history](../launches#launch-status)
...
headers:
  all:
    request:
      - insert:
          name: "subgraph-token"
          value: "${MY_SECRET}" # highlight-line
```
