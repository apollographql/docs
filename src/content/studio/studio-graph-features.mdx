...
This article describes Apollo Studio features for all [graph types](./org/graphs/#graph-types). For features specific to supergraphs, see also [Supergraph-specific Studio features](./federated-graphs/).

## Creating graphs

**To create a cloud supergraph,** see the [GraphOS quickstart](./getting-started/).

**To create a _non_-cloud graph** (i.e., a self-hosted supergraph or a monograph), see [this section](./org/graphs/#creating-graphs).
