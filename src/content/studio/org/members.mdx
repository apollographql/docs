...
| `Documenter`             | Everything an Observer can do with the addition of the ability to edit the README, graph description, and similar non-operational metadata.                                                                                                                                                                          |                        Enterprise only                         |
...
A few operations aren't listed in the table above because they are _only_ supported by graph API keys, not personal API keys for users in the graph's organization. These are primarily operations that are performed by your GraphQL server. They are:
