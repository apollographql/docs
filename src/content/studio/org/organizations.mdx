...
- Removes all user memberships from your organization
- Permanently deletes all graphs from your organization, along with their associated data. These graph IDs can't be reused later.
- Immediately terminates any paid subscription on your organization, if you have one. We can't issue refunds for this, unfortunately.
