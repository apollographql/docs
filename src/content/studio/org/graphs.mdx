...
> **Note:** Only organization members with the [`Org Admin`, `Graph Admin`, or `Contributor` role](./members/) can edit a variant's README. If a variant is [protected](#protected-variants-enterprise-only), `Contributor`s _cannot_ edit its README.
...
2. Under the Variants section, toggle the switch for the variant you want to make public:
   ...
   <img
     class="screenshot"
     src="../img/toggle-public-variant.jpg"
