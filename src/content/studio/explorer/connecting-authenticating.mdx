...
Safari 13.1 and onwards [blocks third-party cookies by default](https://webkit.org/blog/10218/full-third-party-cookie-blocking-and-more/), and your endpoint would be considered "third-party" to Studio. Safari users would need to "Preferences > Privacy" and uncheck "Prevent cross-site tracking" for requests with cookies to be sent.  
