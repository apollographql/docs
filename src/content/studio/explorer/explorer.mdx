...
To get started with the Explorer, [create a graph](../getting-started/#2-create-your-first-supergraph) in Apollo Studio and then navigate to that graph's Explorer page:
