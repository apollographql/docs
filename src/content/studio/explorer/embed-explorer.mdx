...
You can embed the [Apollo Studio Explorer](./explorer/) for any of your graphs on other websites as well.
...
5. Copy the code snippet for your use case, and paste it into your code:
...
## Setup from Docs (Wizard)

This section of the docs is a "What You See is What You Get" setup wizard for your convenience.
Use the toggles on the page here to configure the Embedded Explorer as you wish, and copy the configured code snippet from the **Embed Code** section when you're satisfied.
