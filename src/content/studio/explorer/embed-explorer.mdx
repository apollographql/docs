...
**If you're embedding a [public variant](../graph-access-permissions/#public-variants),** anyone with access to the embedded Explorer can view your schema and make queries against your variant.
