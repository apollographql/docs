...
**If you're embedding a [public variant](../studio-graph-features/#public-variants),** anyone with access to the embedded Explorer can view your schema and make queries against your variant.
