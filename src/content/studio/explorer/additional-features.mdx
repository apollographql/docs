...
<img className="screenshot" src="../img/explorer-query-plan.jpg" alt="Query plan in the Explorer" width="300" />
...
<img className="screenshot" src="../img/explorer-query-plan-diagram.jpg" alt="Query plan diagram in the Explorer" width="600" />

## Subscription support

> Note that supergraphs do _not_ currently support subscription operations. You can only execute subscriptions in the Explorer with a [monograph](../org/graphs/#monographs).
...
<img className="screenshot" src="../img/explorer-subscriptions-settings.jpg" alt="Subscription settings in the Explorer" width="500" />

When you execute a subscription, a Subscriptions panel appears in the bottom-right of the Response panel:

<img className="screenshot" src="../img/explorer-subscriptions-panel.jpg" alt="Subscriptions panel in the Explorer" width="500" />
...
If you've enabled [public access to a variant of your graph](../studio-graph-features/#public-variants), you can embed the Explorer in a webpage that you can then provide to your graph's consumers. This enables those consumers to test out operations from your own website.
