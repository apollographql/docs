...
If you log in to Apollo Studio from Sandbox, you can run [schema checks](../schema-checks/) between your Sandbox schema and any graph you have access to in the Apollo registry.
...
To provide a "Sandbox-like" experience for production endpoints, we recommend using either a [public variant](../graph-access-permissions/#public-variants) or the [embedded Explorer](./embed-explorer).
