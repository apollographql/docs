...
You can pass `includeCookies: true` if you want `{ credentials: 'include' }` to be passed as an option whenever requests are made from Explorer. If you pass a `handleRequest`, this option will be ignored.
