...
To provide a "Sandbox-like" experience for production endpoints, we recommend using either a [public variant](../studio-graph-features/#public-variants) or the [embedded Explorer](./embed-explorer).
