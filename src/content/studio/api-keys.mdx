...
Personal API keys are useful for local development tools (like the Apollo [CLI](/devtools/cli/) and [VS Code extension](/devtools/editor-plugins/)) to load schemas and other data from Studio.
