...
| Page | Description |
|------|-------------|
| **README** | Displays the variant's editable Markdown-formatted README, along with other important details about the variant (such as its graph ref and router URL). [Learn more](./org/graphs#the-readme-page) |
| **Schema** | Documentation for all your supergraph's types and fields. Supports filtering definitions by name, subgraph, and other values. [Learn more](./org/graphs#the-schema-page) |
