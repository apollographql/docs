...
Apollo Studio **contracts** enable you to deliver different subsets of your graph to different consumers. Each contract filters out specific portions of your graph's [API schema](https://www.apollographql.com/docs/federation/#federated-schemas) into a different Studio variant:
...
Contracts filter out type and field definitions from your subgraph schemas based on `@tag` directives that you add:
