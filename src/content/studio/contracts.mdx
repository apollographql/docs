...
>
> - **If you use Rover v0.8.0 or v0.8.1,** contract checks _do_ run, but the execution ignores any [blocking downstream variants](#failing-contract-checks) you've set.
