...
<img
  ...
  src="./img/edit-supported-directives.jpg"
  width="600"
/>
...
```graphql {1-6,9,14,18-21} title="products.graphql"
...
Note that you can use `@inaccessible` to mark schema elements that should not be accessible in the public facing schema. This is useful when creating a public contract variant. See the `@inaccessible` [spec](https://specs.apollo.dev/inaccessible/v0.1/) for more details. 
