[The GraphOS Router](https://www.apollographql.com/docs/router/) supports a collection of premium features specific to GraphOS. These include:
...
- Mitigation of potentially malicious requests via [operation limits](https://www.apollographql.com/docs/router/configuration/operation-limits) and [safelisting](https://www.apollographql.com/docs/graphos/operations/persisted-queries)
