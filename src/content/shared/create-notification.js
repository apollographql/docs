  ...
  return (
    <>
      ...
      <OrderedList spacing="4">
        <ListItem>
          Select the <strong>Reporting</strong> tab.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          If you&apos;re configuring a new channel, complete the steps in the
          next section.
        </ListItem>
        {notificationType === 'Daily report' && (
          <ListItem>
            Select a time zone. The report is sent daily at 9 AM in the selected
            time zone.
          </ListItem>
        )}
      </OrderedList>
