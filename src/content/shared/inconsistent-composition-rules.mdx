...
<RuleExpansionPanel
  ...
  whatItDoes="Checks that the same fields are declared for all object [value type](https://www.apollographql.com/docs/federation/federated-types/sharing-types) (has no `@key` in any subgraph) in all subgraphs that declare the type."
