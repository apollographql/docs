...
1. Ensure your router instances are ready to work with PQLs:
   ...
   - Make sure you're using version `1.32.0` or later of the router. (The feature was released in [preview](/resources/product-launch-stages/#preview) in version `1.25.0` and made [generally available](/resources/product-launch-stages/#general-availability) in `1.32.0`.)
