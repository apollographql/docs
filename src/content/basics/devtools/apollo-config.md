...
1. Use the Apollo [schema registry](/graphos/delivery/)
2. With a remote endpoint (from a running server)
3. With a local schema file

#### Option 1: Use the Apollo schema registry

To link your client to a schema through the Apollo schema registry, you'll need to have at least one version of your schema published to the [registry](/graphos/delivery/).
...
> **Note:** you must have a [published schema](/graphos/delivery/) for features like VS Code intellisense, which requires knowledge of your schema, to work properly.
