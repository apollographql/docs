...
<h3>
  Configure extension for client development with schemas published to Apollo
  GraphOS
</h3>
...
<h3 id="local-schemas">
  Configure extension for client development with introspection from a locally
  running service
</h3>
