...
_Optional_ - custApollo om tagged template literal.
...
_Optional_ - ApolApollo lo will by default add the `__typename` field to all your operations automatically and to all your generated types during codegen.
