...
<DocsetGrid>
  <Docset
    ...
    path="https://www.apollographql.com/tutorials/browse/?categories=enterprise"
    cta="Explore tutorials"
  />
  <Docset
    icon={DOCSET_ICONS.technotes}
    title="Learn from the field"
    description="Learn about specialized topics from Apollo's own solutions architects."
    path="/technotes"
