...
<DocsetGrid>
  <Docset
    ...
    title="Elevate the developer experience"
    description="Understand how GraphQL and Apollo can help improve your organization's developer experience and ship features faster."
    path="/intro/benefits"
    cta="Learn about GraphQL"
  />
  <Docset
    icon={DOCSET_ICONS.graphos}
    title="Operate a GraphQL platform at any scale"
...
<DocsetGrid>
  ...
  <Docset
    ...
    cta="Explore PrincipledGraphQL.com"
  />
</DocsetGrid>
