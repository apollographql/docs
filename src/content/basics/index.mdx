...
**Apollo Client** is the industry-standard GraphQL client library. Execute GraphQL operations, cache their results, and manage all your application's state in one place.
