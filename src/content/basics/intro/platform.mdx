...
To act as a subgraph, a GraphQL server library needs to support the [Apollo Federation subgraph specification](/federation/subgraph-spec/). Fortunately, many popular libraries do!
...
* Any of the other server libraries listed in [Subgraph-compatible server libraries](/federation/supported-subgraphs/)
