...
GraphOS Studio also has some integrations to make monitoring easier. [Notifications](/graphos/metrics/notifications/) delivers daily reports to give teams a quick overview of the health of their schema. The enterprise [Datadog integration](/graphos/metrics/datadog-integration/) works with existing Datadog accounts to help teams track schema performance.
