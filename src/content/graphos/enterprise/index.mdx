...
GraphOS provides schema pipeline tools to efficiently develop and deploy changes to your supergraph schema. Check out the [Schema pipeline overview](../delivery) to learn more about the full suite of tools.

### Schema change management with proposals

[Schema proposals](../delivery/proposals) provide GraphOS-native schema change management.
