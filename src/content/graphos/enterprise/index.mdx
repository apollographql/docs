...
- The [Apollo Datadog integration](../metrics/datadog-integration) let you forward performance metrics to your Datadog account. Datadog supports an advanced function API, which enables you to create sophisticated visualizations and alerts for GraphQL metrics.
