...
- [**Authorization**](/router/configuration/authorization) of specific fields and types through the [`@requiresScopes`](/router/configuration/authorization#requiresscopes) and [`@authenticated`](/router/configuration/authorization#authenticated) directives
