...
With GraphOS Enterprise, you can deploy your supergraph's router instances into your own infrastructure, instead of using a GraphOS-provisioned cloud router:
