...
In a modern cloud-native stack, your components must be scalable with high availability. The [Apollo Router Core](/router) is built with this in mind. The router is [much faster and less resource-intensive than the Apollo Gateway](https://www.apollographql.com/blog/announcement/backend/apollo-router-our-graphql-federation-runtime-in-rust/#apollo-router-vs-apollo-gateway-benchmarks), Apollo's original runtime.
...
- [Apollo Router Core introduction](/router/)
