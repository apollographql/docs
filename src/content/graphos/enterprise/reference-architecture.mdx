...
Val: I'd add a blurb on where GraphOS fits into a modern cloud-native stack. This should set the scene for how this arch has been built and the choices we made.
