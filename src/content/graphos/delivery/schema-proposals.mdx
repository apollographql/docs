...
graph LR
    ...
    Check[["GraphOS integrated* <br/> schema checks"]]
...
graph LR
    ...
    direction LR
    Checks[["GraphOS proposals** <br/> schema checks"]]
...
\*\* Proposals schema checks refer to checking published changes correspond to an approved proposal.
