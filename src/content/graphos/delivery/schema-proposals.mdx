...
<td>
Automatic upon creation but can be <a href="./propose-changes#change-proposal-status">manually reset</a>
</td>
<td>
...
<td>Signals the proposal is ready for review.</td>
</tr>
<tr>
<td>
...
Proposal default configurations let you start using them out of the box. If you want to finetune your graph's proposal process, including permissions, approval requirements, and more, check out [Proposal configuration](./configure-proposals).
