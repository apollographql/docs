...
You can manually change the proposal's stage from the overview page by clicking **Edit stage**. You have the following choices:

- **Draft**: default stage upon creation
...
- **Closed**: signals the proposal is abandoned or suspended
  ...
  - You can always reopen a proposal by resetting the stage to Draft or Open for feedback
...
**Approved** and **Implemented** stages are automatically set once [necessary conditions](./schema-proposals#proposal-stages) have been met.
