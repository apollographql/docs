...
This guide covers running your first schema check and integrating checks into your CI pipeline.
See [Configure Schema Checks](./check-configurations) for configuration options.
