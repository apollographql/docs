...
You can create customized linter rules to forbid or require certain strings as the prefix or suffix for different schema elements. You can create rules for the following elements:
