...
On your graph's **Checks** page in Studio, you can see the status of contract checks by clicking the Satellite icon:
...
On a check's details page, the contact check appears as **Downstream** in the **Task** column.
