...
After you [enable schema checks](./run-checks) for your graph, you can customize their behavior to suit your use case. For example, you can:
...
If you haven't already, you may want to connect schema checks to GitHub.
