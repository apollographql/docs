...
- [**Linting checks.**](./schema-linter/) Analyze your proposed schema changes for violations of formatting rules and other GraphQL best practices.
...
- For details on linting checks, see [Schema linting](./schema-linter/).
