---
title: Schema checks
subtitle: Validate all proposed changes to your schema are safe
...
- [**Proposals checks**](./schema-proposals) (Enterprise only): Check whether your proposed schema changes have matching and approved [schema proposals](./schema-proposals).
...
- For details on proposals checks, see [Schema proposals check configuration](./configure-proposals#configure-schema-checks).
