...
You can use [ignored conditions settings](#ignored-conditions-settings) to ignore all potentially breaking changes when they are detected on a variant that does not have any traffic.
