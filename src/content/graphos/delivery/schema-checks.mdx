...
If a composition check fails, Studio does not perform any other checks for the provided schema.
...
To run your first check, integrate checks into your CI pipleine, and customize checks refer to [Run schema checks](./check-configurations).
