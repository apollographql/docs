...
Operations checks will run against a maximum of 10,000 distinct operations. A warning message will display in Studio when a larger cardinality has been reached.
