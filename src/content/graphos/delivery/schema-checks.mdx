...
- [**Proposals checks**](./schema-proposals/configuration#configure-schema-checks) (Enterprise only): Check whether your proposed schema changes have matching and approved [schema proposals](./schema-proposals).

- **[Contract checks](./contract-setup/#run-contract-checks)** (Enterprise only): When running schema checks on a source variant, also check whether your proposed schema changes will break any downstream contract variants.
