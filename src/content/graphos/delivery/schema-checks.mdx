...
Additionally, if you run a check within a Git repository, `rover subgraph check` will include both the commit hash and the author of said hash to GraphOS to display on the check.
