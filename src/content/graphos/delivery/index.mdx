...
- _Schema governance_ tools let you manage, validate, and enforce standards in your schemas.
- _Schema delivery_ tools let you integrate schema publication into your DevOps workflows.
