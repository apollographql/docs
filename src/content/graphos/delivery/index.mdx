...
Schema delivery refers to the process of making your supergraph schema available to clients. GraphOS requires you to [publish schema changes using the Rover CLI](./publication). Publication happens via a CLI command so you can readily integrate it into your continuous delivery pipeline.
