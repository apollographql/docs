...
It becomes more difficult to assess the impact of subgraph schema changes on [composition](/federation/federated-types/composition/) and client operations.
...
Team members [create](./creation), [review](../review), and [approval](../review#approved-reviews) schema proposals in GraphOS Studio. After approval, the team implements the proposal&mdash;including resolver and any supporting code changes&mdash; before publishing the schema changes to GraphOS.
