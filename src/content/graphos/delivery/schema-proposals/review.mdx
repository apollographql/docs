...
- The [**Schema Reference**](#schema-reference) tab shows the entire supergraph schema with the proposal's changes applied.
...
Since the **Schema reference** tab shows the entire supergraph schema, it can be helpful to get a complete picture of your supergraph schema if the proposal were implemented.

Select **Proposal changes only** to hone in on parts of the schema that the proposal changes.

<img
  src="../../img/schema-proposals/schema-reference.jpg"
  className="screenshot"
  alt="The schema proposals schema reference tabs in GraphOS Studio"
/>

You can also filter by subgraph, tag, directive, return types, and arguments to narrow your view.
