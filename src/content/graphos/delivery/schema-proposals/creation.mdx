...
<img
  ...
  className="screenshot"
  alt="Subgraph selector in the schema proposals editor in Studio"
  width="200px"
/>
...
<img
  ...
  className="screenshot"
  alt="Highlighting violations in the schema proposals editor in Studio"
/>
...
Once you've made changes, click the **Save Revision** button in the bottom left of the editor to save them to your proposal.
