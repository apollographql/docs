...
- The [minimum number of approvals](#required-approvals) needed for a proposal to achieve [**Approved** status](./#proposal-statuses)
- Whether and how [schema checks incorporate proposals](#configure-schema-checks)
- Whether to [turn off email notifications](#turn-off-notifications) of proposal activity
