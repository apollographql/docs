...
| [Require reapprovals after revisions](#require-reapprovals)                       | Whether to require reapprovals after an approved propsal is revised |
...
With this setting enabled, reviews are re-requested automatically from anyone who previously approved.
