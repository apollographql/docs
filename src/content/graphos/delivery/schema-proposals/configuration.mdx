...
| [Description template](#configure-description-template)                   | An editable description that prepopulates for every new proposal created for the graph.|
...
Configuring a graph's description template prepopulates the description for every new proposal any team member creates for the graph. You can edit a prepopulated description during proposal creation and throughout the proposal process.
