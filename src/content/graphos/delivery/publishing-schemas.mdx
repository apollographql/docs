...
This page covers how to publish different kinds of schemas using the Rover CLI. Refer to the [Platform API](/graphos/platform-api/) reference for which operations to use for publication.
