...
Incorporate [schema proposals](./schema-proposals) into [schema checks](./schema-checks) to ensure your organization only publishes preapproved changes. [Learn more.](./schema-proposals/implementation#ensure-changes-match-an-approved-proposal)
...
2. **If you're publishing a subgraph for the first time,** _also_ obtain the **routing URL** of that subgraph. This is the URL that your router will use to communicate with the subgraph.
