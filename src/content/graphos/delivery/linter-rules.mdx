...
> Composition rules are only available for graphs on [federation version `2.5`](/federation/federation-versions/#v25) or later. You can update a graph's version from its **Settings** page in [GraphOS Studio](https://studio.apollographql.com?referrer=docs-content).
