...
The _minimum_ [role](../org/members/#organization-wide-member-roles) required to create, edit, and approve proposals.

<br/>

`Observers` is the least restrictive setting and `Admins` the most restrictive.
The `Observers` default means all organization members except Consumers and Billing Admins can create, edit, and approve proposals.
If you select `Admins`, only org and graph admins can create, edit, and approve proposals.
