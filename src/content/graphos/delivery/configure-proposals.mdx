...
All team members receive email notifications for the following proposal actions:

- Whenever you're selected as a review on a proposal, whether because you are a default reviewer, or you've been manually selected
- Whenever you are @mentioned in a comment

Additionally, the following roles receive notifications on the following proposal actions:
