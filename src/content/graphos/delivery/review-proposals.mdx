...
Share comment by clicking the link button to copy its URL.
...
The **Schema Reference** tab shows the entire supergraph schema reference with the proposal's changes applied:
...
Select **Proposal changes only** to view only the changes.
