...
You can use the left nav to view changes from a particular subgraph, or see the changes in the context of the composed [supergraph schema](/federation/federated-types/overview/#supergraph-schema) or [resulting API schema](/federation/federated-types/overview/#api-schema).

#### Add comments

You can comment on any line in the detailed view's diff. Hover over the line and click on the chat icon that appears.
...
A dialog appears where you can leave general commentary on the proposal and select to approve the proposal or not.
