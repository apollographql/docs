---
title: Contracts
subtitle: Deliver different subsets of your enterprise supergraph
...
> Contract checks rely on the supergraph schema that's generated by build checks, so they _don't_ execute if that composition _fails_.
