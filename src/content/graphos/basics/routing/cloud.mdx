...
Cloud routing on the [Dedicated](./cloud-dedicated) plan has a wider variety of options. <a href="mailto:cloud@apollographql.com" onClick={() => window?.gtag?.('event', 'docs_content_contact_cloud')}>Get in touch</a> to learn more.
