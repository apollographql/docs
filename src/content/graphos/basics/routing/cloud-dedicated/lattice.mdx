...
<img class="screenshot" alt="AWS VPC service page" src="../../../img/cloud-dedicated/create-target-group.jpg" width="500" />

4. In the **Basic configuration** section, set the properties that match your subgraph resources.

<img class="screenshot" alt="AWS VPC service page" src="../../../img/cloud-dedicated/target-group-configuration.jpg" width="500" />
