...
A Lattice **target group** is a collection of targets, or compute resources, that run your application or service. Check out the [AWS documentation](https://docs.aws.amazon.com/vpc-lattice/latest/ug/target-groups.html) to learn more.
