...
**If you require more advanced router customization,** please <a href="https://www.apollographql.com/contact-sales/" onClick={() => window?.gtag?.('event', 'docs_content_contact_sales')}>reach out</a> to learn about your about Dedicated and Enterprise plan options.
