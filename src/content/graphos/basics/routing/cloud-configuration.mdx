...
[Dedicated and Enterprise plans](../org/plans/) offer a [wide variety of configurations](/router/configuration/overview#yaml-config-file).
...
> **If you require more advanced router customization,** please [reach out](https://www.apollographql.com/contact-sales/) about Dedicated and Enterprise plans.
