...
description: Learn how to configure cloud routers and manage secrets in GraphOS Studio
---

After you [create a cloud supergraph](../quickstart/cloud/), you can view and manage its router's configuration from GraphOS Studio. Go to the **Settings** page for your variant in Studio, then click the **Cloud Router** tab:
...
You can configure your router's behavior in the **Router configuration YAML** section of the **Cloud Router** tab.
...
[Dedicated and Enterprise plans](../org/plans/) offer a [wider variety of configurations](/router/configuration/overview#yaml-config-file).

**If you require more advanced router customization,** please <TrackableLink href="https://www.apollographql.com/contact-sales" eventName="content_contact_sales">reach out</TrackableLink> to learn about your about Dedicated and Enterprise plan options.
...
By default, the router enables _only_ GraphOS Studio to initiate browser connections to it. If your supergraph serves data to other browser-based applications, you need to do one of the following in the `cors` section of your **Router configuration YAML**:
