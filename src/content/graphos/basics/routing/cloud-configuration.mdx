...
[Dedicated and Enterprise plans](../org/plans/) offer a [wide variety of configurations](/router/configuration/overview#yaml-config-file). On the [Serverless plan](../org/plans/), you can configure:
