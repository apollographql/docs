...
With GraphOS, you can [**host your own**](../quickstart/self-hosted) Apollo Router, a configurable, high-performance routing runtime packaged as a standalone binary:
...
- [Self-hosted router](../quick-start/self-hosted)
