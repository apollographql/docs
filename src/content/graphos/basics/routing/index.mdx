...
The cloud router uses the same Apollo Router binary. If you use a cloud router, you can choose to run it on shared or dedicated infrastructure. Running it on dedicated infrastructure offers more configuration options. Continue reading for a detailed comparison of your router options.
