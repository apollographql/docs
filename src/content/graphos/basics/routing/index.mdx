...
- **Compliance.** All your supergraph's components must be hosted in a particular region to adhere to compliance requirements.
...
With the exception of Apollo-managed routing, self-hosted supergraphs benefit from all the same GraphOS features as cloud supergraphs: metrics reporting, schema checks, the Explorer, etc.

If you are interested in either Cloud Dedicated or self-hosted routing, don't hesitate to <TrackableLink href="https://www.apollographql.com/contact-sales" eventName="content_contact_sales">get in touch</TrackableLink>.
...
- [Cloud router on dedicated infrastructure](./cloud-dedicated)
