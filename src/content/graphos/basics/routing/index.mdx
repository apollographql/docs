---
title: Routing for supergraphs in GraphOS
description: Choose between self-hosted and cloud routing options
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Highly configurable, including all options in the Dedicated cloud router
        and additional{' '}
...
Somes organizations might need to use Dedicated cloud or self-hosted routing instead of shared cloud routing for these reasons:
...
If you are interested in either Dedicated cloud or self-hosted routing, don't hesitate to [get in touch](https://www.apollographql.com/contact-sales/).
