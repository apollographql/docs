...
<EnterpriseFeature
  text={`**The following requires a GraphOS Enterprise plan**:
- Reporting metrics from a [monograph](../graphs/#monographs)
- [self-hosted supergraph](../graphs/#self-hosted-supergraphs)
- Forwarding metrics from [Apollo Server](/apollo-server/)\n
