...
**Subscribing to Sub-processor updates is temporarily disabled as we migrate our communication list.** This article remains the canonical location for Apollo Sub-processor details.
