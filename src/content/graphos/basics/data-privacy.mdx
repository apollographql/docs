...
| `https://router.apollo.dev`                            | The GraphOS Router installer (all versions), along with GraphOS Router (v1.9.0+) [telemetry when enabled](/router/privacy)                                                                                                                                                                |
...
If you enable [enhanced operation signature normalization](/router/configuration/overview#enhanced-operation-signature-normalization) in the router, the operation signature includes the input object shapes while redacting any of the actual values. [Learn more.](/router/configuration/overview#enhanced-operation-signature-normalization)
