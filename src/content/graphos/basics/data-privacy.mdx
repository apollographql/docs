...
To request the deletion of specific data from your Apollo organization, please email [support@apollographql.com](mailto:support@apollographql.com) with the subject `Data deletion request`.
