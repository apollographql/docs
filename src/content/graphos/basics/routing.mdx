...
A router connected to GraphOS, regardless of whether it's cloud- or self-hosted is called a **GraphOS Router**, and has access to [specific GraphOS features](/docs/router/graphos-features/) depending on the connected GraphOS organization's plan.
