---
title: Deferring Query Response Data
subtitle: Using the @defer directive
description: Optimize your GraphQL queries by deferring response data with the @defer directive. Learn how to enhance client experience and speed up data retrieval.
---
...
- Your supergraph must be one of:
  ...
  - A [self-hosted supergraph](../graphs/#self-hosted-supergraphs) running the [GraphOS Router](/router/)
