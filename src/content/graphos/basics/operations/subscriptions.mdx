...
You can also use subscriptions with an Enterprise self-hosted supergraph. See the [GraphOS Router documentation](/router/executing-operations/subscription-support/).
