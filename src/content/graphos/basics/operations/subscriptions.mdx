...
You can also use subscriptions with an Enterprise self-hosted supergraph. See the [Apollo Router documentation](/router/executing-operation/subscription-support/).
