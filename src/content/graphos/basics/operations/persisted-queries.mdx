...
GraphQL APIs are broadly open by design. While allowing freeform requests expedites client development, it necessitates securing your graph against potentially malicious requests. 
...
<table>
  <thead>
    <tr>
      ...
      <th>Registered persisted queries</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Query performance</td>
      <td>✅ Clients can send identifiers instead of full operation strings, reducing request sizes dramatically and latency.</td>
      <td>✅ Same as APQ</td>
    </tr>
    <tr>
