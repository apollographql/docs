...
Safelisting is a key component of GraphOS' security features and complements others such as [JWT authentication](/router/configuration/authn-jwt/) and [operation limits](/router/configuration/operation-limits). Safelisting empowers you to reduce the surface of your supergraph by restricting the shape of incoming operations.
