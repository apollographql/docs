...
After you link a PQL to a variant, GraphOS uploads the PQL to [Uplink](/federation/managed-federation/uplink/), the service that delivers configuration to your router at runtime.
