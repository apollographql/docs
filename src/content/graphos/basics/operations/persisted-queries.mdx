...
The router works with both formats since the PQL-specified ID is the query string's [SHA-256](https://en.wikipedia.org/wiki/SHA-2), and the router can derive it from the query string if needed. 
