...
From the **Persisted Query Lists** page, you can perform the following actions by clicking the menu button under **Actions** on the right of any PQL:
...
If you want to delete an operation, you must do so from Studio. From the persisted query lists page, click a persisted query list to open it. Then, click the **Actions** button next to a particular operation and select **Delete**.
