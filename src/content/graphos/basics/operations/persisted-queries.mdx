...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      Generate and publish a persisted queries manifest (PQM) to the PQL from you client's CI/CD pipeline.
      </td>
...
After you [generate an operation manifest](#31-generate-peristed-queries-manifests), you publish it to your PQL with the [Rover CLI](/rover/):
...
2. Follow all [implementation steps](#implementation-steps) for your chosen client:
    ...
    1. When [configuring the router](#2-enable-safelisting) begin with [audit mode](#audit-mode-dry-run).
