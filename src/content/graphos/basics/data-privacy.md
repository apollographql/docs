...
| `https://rover.apollo.dev`                            | All [Rover CLI](/rover/) commands when telemetry is enabled, `rover supergraph compose` when fetching new plugin versions, all `rover template` commands, and once a day to check for updates.
