...
| `https://rover.apollo.dev`                            | All [Rover CLI](/rover/) commands when telemetry is enabled, and `rover supergraph compose` when running a federation version for the first time, and once a day to check for updates.
