...
> The Apollo Router provides expanded performance, security, and customization features for organizations with a [GraphOS Enterprise plan](/graphos/enterprise/).
> 
