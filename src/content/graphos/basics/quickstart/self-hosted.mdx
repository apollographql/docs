...
A **self-hosted supergraph** is a supergraph with a router that you host and manage in your own infrastructure. This is in contrast to a [**cloud supergraph**](./cloud/), which uses a router that's hosted and managed by Apollo.
