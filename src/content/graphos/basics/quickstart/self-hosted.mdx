...
This tutorial gets you up and running with GraphOS and a self-hosted supergraph. If your organization _doesn't_ currently have an Enterprise plan and you want to test out this functionality, **[sign up for a free Enterprise trial.](../org/plans/#enterprise-trials)**

> **Important:** This tutorial uses [Docker](https://www.docker.com/) for containerization of your supergraph's router.
...
1. Obtain a graph API key for your Studio graph by following these steps:
    ...
    **If you have an Enterprise plan,** set the API key's role according to the following:
    ...
    - If your router will use a [protected variant](../graphs/studio-features/#protected-variants-enterprise-only), choose **Graph Admin**.
...
<img
  ...
  alt="The Insights page in Studio"
/>

The test queries you executed in the previous step should already be represented on this page. (If they aren't there yet, check the page again in a few minutes.) After you update all of your clients to query your router, the **Insights** page becomes vital to monitoring your supergraph's performance.
