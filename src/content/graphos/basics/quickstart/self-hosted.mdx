...
> Connecting a self-hosted Apollo Router to GraphOS requires an Enterprise plan. Organizations with an Enterprise plan also have access to expanded performance, security, and customization features in the router.
> 
