...
Here's a powerful benefit of a cloud supergraph: because clients execute operations against your GraphOS-managed router, the router can collect metrics on those operations and their fields. You can then visualize those metrics in Studio.
