...
/>
 ...
 legacy organizations can upgrade to a current plan. [See details.](../org/plans#upgrading-to-a-current-plan)
...
**To allow browser-based queries from any domain,** you can instead set `allowanyorigin: true`:
