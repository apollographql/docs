...
1. From your new organization in [Apollo Studio](https://studio.apollographql.com/?referrer=docs-content), navigate to the **Graphs** tab if it isn't already open.
...
Here's a powerful benefit of a cloud supergraph: because clients execute operations against your GraphOS-managed router, the router can automatically collect metrics on those operations and their fields. You can then visualize those metrics in Studio.
...
The operations you [executed in the Explorer](#4-query-your-supergraph) should already be represented on this page. After you update all of your clients to query your router and configure your router, the Insights page becomes vital to monitoring your supergraph's performance.
