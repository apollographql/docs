...
subtitle: Add a subgraph to your supergraph using a template or existing API
description: Access templates to build a new subgraph that you can add to your GraphOS supergraph, whether you already have a GraphQL API or are building from scratch.
---
