...
Organization members with the [**Consumer** role](../org/members#organization-wide-member-roles) can only view the API schema. **Observers**, **Documenters**, **Contributors**, **Graph Admins**, and **Org Admins** can see all schema types.
