...
When you [publish a subgraph's schema](../delivery/cli-registration/), you can specify which variant of the supergraph you're publishing that schema to.
...
[Learn about publishing subgraph schemas.](../delivery/cli-registration/#subgraph-schemas)
