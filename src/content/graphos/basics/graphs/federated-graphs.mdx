---
title: Supergraph-Specific Features
subtitle: Learn about variants, managing subgraphs, and viewing compositions errors
description: Use GraphOS Studio facilitates collaboration on federated GraphQL APIs. Manage variants, add subgraphs, and view schema details effortlessly.
---
...
<img
  class="screenshot"
  src="../../img/federated-graphs/schema-reference-tag-passthrough.jpg"
...
If a supergraph's most recent set of subgraph schemas failed to compose, a **BUILD FAILED** label is shown at the top of the supergraph's page in Studio. You can click this label to view the errors that must be resolved before composition can succeed. Refer to the [composition error reference](/federation/errors/) for more information.
