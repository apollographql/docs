...
subtitle: Learn about graph types, variants, and how to publish schemas
description: Explore the benefits, architectures, and considerations for graph types like cloud supergraphs, self-hosted supergraphs, and monographs.
---
...
- A GraphOS Router hosted in your infrastructure
- One or more subgraphs hosted in your infrastructure
...
5. Click **Next**. A dialog like the following appears (the details differ depending on which **Graph Architecture** you're using):
   ...
   <img src="../../img/register-schema-dialog.jpg" class="screenshot" alt="Schema registration options" width="600" />
...
<img src="../../img/management/graph-variants.jpg" className="screenshot" alt="Schema Changelog tab" width="700" />
