...
import { Tabs as TabsChk, TabList, TabPanels, Tab as TabChk, TabPanel } from '@chakra-ui/react'
...
<Tabs labels={['Cloud supergraph','Non-cloud supergraph']}>

<Tab label="Cloud supergraph">

To create a cloud supergraph, see the [GraphOS quickstart](../quickstart/cloud/).

</Tab>

<Tab label="Non-cloud supergraph">
