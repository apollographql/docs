...
description: Enhance GraphQL schema comprehension and design with Apollo GraphOS Studio, including the schema visualization, the Explorer, and schema changelog. 
---
...
The **Reference** tab on the **Schema** page lists the different kinds of definitions in your schema, for example, objects, scalars, etc.:
...
The **Visualization** tab provides a clear graphical representation of your schema's structure, including types, fields, and relationships.
It can help identify potential issues in your data model, allowing for more effective schema design.
...
The bottom of the visualization has buttons for:
- Zooming in and out of the visualization
- Copying a link to the visualization to share with organization members
- Downloading an SVG or PNG of the visualization
- Opening and closing the visualization **Legend**

On the top of the page, you can:
- Click the double arrow to collapse or expand a searchable list of **Types**.
- Click **Show Filters** to filter your visualization by root type, subgraph, or tag.
- Click the **Highlight** dropdown to select particular types, tags, or directives to highlight.
  - Highlighting **Unused** types, **Errors**, **Usage**, or **Latency**, the visualization displays a heatmap whose **Time range** you can adjust in the bottom right of the screen.
    ...
    <img
      src="../../img/schema-visualization-heatmap.png"
      className="screenshot"
      alt="Visualization heatmap showing unused types and fields in a schema visualization"
    />
