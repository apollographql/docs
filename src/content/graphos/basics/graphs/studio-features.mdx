...
When a user opens one of your graph's variants in GraphOS Studio, its **README** page appears. Like the typical homepage for a Git repository, this page displays a Markdown-based README that you can edit with any content you like.
...
<img
  src="../../img/schema-page/visualization.png"
  className="screenshot"
