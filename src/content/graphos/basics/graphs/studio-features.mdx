...
**To create a non-cloud graph** (that is, a self-hosted supergraph or a monograph), see [this section](./#creating-graphs).
...
Only organization members with the [**Org Admin**, **Graph Admin**, **Contributor**, or **Documenter** role](../org/members/) can edit a variant's README. If a variant is [protected](#protected-variants-enterprise-only), **Contributor**s cannot edit its README.
...
- **Contributor**s cannot push schema updates to a protected variant.
- **Contributor**s cannot manage Explorer-related settings for a protected variant, such as setting the variant's endpoint URL.
...
Note that **Org Admin**s can always see all graphs in your organization.
