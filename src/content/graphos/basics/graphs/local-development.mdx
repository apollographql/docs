---
title: Local Subgraph Development
subtitle: Use the Rover CLI to run a local supergraph
description: Run a local supergraph with the Rover CLI for rapid schema changes. Boost development by testing GraphQL operations using the Explorer.
---
