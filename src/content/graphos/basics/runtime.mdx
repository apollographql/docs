...
Cloud and self-hosted runtimes are both powered by the Apollo Router—a high-performance runtime packaged as a [standalone binary](https://github.com/apollographql/router).
