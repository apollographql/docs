---
title: API Keys
subtitle: Use graph and personal API keys to authenticate requests
description: Use API keys to authenticate requests to your federated GraphQL API. Generate and manage  graph and personal API keys using Apollo GraphOS Studio.
---
