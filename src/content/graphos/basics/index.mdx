...
- **The schema registry.**
  - GraphOS tracks the GraphQL schemas for all your individual subgraphs, and it also handles **composing** those subgraph schemas into one _supergraph_ schema for your router.
