...
- [Connect your self-hosted router to GraphOS](./quickstart/self-hosted/)
  - The Apollo Router Core is available as a free and source-available runtime for Apollo Federation. Connecting your self-hosted router to GraphOS requires an Enterprise plan.
