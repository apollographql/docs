...
> [See all Apollo plans.](https://www.apollographql.com/pricing/)
...
- [**Connect your self-hosted router to GraphOS.**](./quickstart/self-hosted/) Apollo Router is available as a free and source-available runtime for Apollo Federation. Connecting your self-hosted router to GraphOS requires an Enterprise plan.
...
- **Extended data retention.**
  - Your supergraph's historical operation metrics are available for visualization in Studio significantly longer than with a **Serverless** plan. See the pricing page's [section on data retention](https://www.apollographql.com/pricing#data-retention) for details.
...
**If you're interested in Enterprise features,** please [get in touch with us!](https://www.apollographql.com/contact-sales/) You can also test out these features with a free [Enterprise trial](./org/plans/#enterprise-trials).
