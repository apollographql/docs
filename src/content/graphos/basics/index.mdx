...
flowchart LR;
  ...
  router(["Cloud Routing"]);
  studio(["Studio UI"]);
  end;
  subgraph "Your infrastructure";
  products["GraphQL Service<br/>A"];
  reviews["GraphQL Service<br/>B"];
