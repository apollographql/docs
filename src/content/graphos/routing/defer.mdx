...
- Your supergraph must be one of:
  ...
  - A [self-hosted supergraph](../graphs/overview/#self-hosted-supergraphs) running the [Apollo Router](/router/) (_not_ the Node.js Apollo Gateway)
