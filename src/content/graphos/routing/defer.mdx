...
>
> Defer support is currently available in Apollo Client for [Web](/react/data/defer) and [Kotlin (experimental)](/docs/kotlin/fetching/defer).
...
- Clients must support receiving deferred query responses as multipart HTTP responses.
  - This functionality is currently supported in Apollo Client for [Web](/react/data/defer) and [Kotlin (experimental)](/docs/kotlin/fetching/defer).
