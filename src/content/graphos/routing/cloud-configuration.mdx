...
After you [create a cloud supergraph](../quickstart/cloud/), you can view and manage its router's configuration from Apollo Studio. Go to the **Settings** page for your variant in Studio, then click the **Cloud Routing** tab:
...
- [Subgraph error inclusion](#subgraph-error-inclusion) to expose subgraph errors to clients including Apollo Explorer.
