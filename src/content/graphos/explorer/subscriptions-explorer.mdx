...
Remember that the path _and protocol_ of your subscriptions URL might differ from those of your _primary_ endpoint.
...
If you can't connect to your subscriptions endpoint, double-check all of the following in the Explorer's **Connection settings**:
