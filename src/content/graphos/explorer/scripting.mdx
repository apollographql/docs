...
- f graphRef is undefined, scope is required
...
If scripts accidentally reference each other creating circular depedency, the Explorer will try a few more times in case ther is script logic that
