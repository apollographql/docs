...
For [protected variants](../graphs/management/#public-variants), only organization members with the **Graph Admin** role can create or edit a variant's preflight script.
