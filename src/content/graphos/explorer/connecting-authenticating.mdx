...
When you use the Explorer with a [cloud supergraph](../graphs/#cloud-supergraphs), the endpoint URL is always the URL of your current variant's GraphOS Router.
