...
- Operation Scripts have the same capabilities as the preflight script, the main differences are:
  ...
  - Operation Scripts are executed after the variants Preflight Script
  - The access controls for editing Operation Scripts is the same as the collection they are on
