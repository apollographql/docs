...
subtitle: Use GraphOS tools without an Apollo account
description: Learn how Apollo Sandbox loads a running GraphQL server's schema and facilitates schema introspection, schema checks, offline usage, and more.
...
<img class="screenshot" src="../img/explorer/sandbox-url.jpg" alt="Sandbox URL field" width="300" />
...
<img class="screenshot" src="../img/explorer/sandbox-diff.jpg" alt="Schema diff in Sandbox" />
...
When you click **Run a check**, Sandbox first performs a build check using your local subgraph schema and the published schemas of your other subgraphs. If composition succeeds, Sandbox then performs operations checks as usual and displays the results of all checks. If composition fails, Sandbox does not perform operations checks and displays the composition error.
...
<img
  class="screenshot"
  src="../img/explorer/sandbox-url-parameters-1.jpg"
...
<img
  class="screenshot"
  src="../img/explorer/sandbox-url-parameters-2.jpg"
...
To provide a "Sandbox-like" experience for production endpoints, we recommend using either a [public variant](../graphs/management/#public-variants) or the [embedded Explorer](./embed-explorer).
