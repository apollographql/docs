...
All data in GraphOS (graphs, schemas, metrics, etc.) is associated with a particular _organization_. Every organization has one or more _members_ who manage it and can access its associated data.
...
<img
  src="../img/management/organization-list.jpg"
