---
title: Export and Read Audit Logs
subtitle: Download a log of all material events that have occurred in your GraphOS organization
description: GraphOS Enterprise users can export and download an audit log of organizational events. Learn how to export and read audit logs from GraphOS Studio.
---
