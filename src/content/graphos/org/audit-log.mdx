...
When creating an audit log export, you specify a **time range**, along with optional filters to limit actions to a particular **user** or **graph**. The maximum time range that you can request audits for is 180 days, as defined by our retention policy.

<img
  src="../img/audit-log-create.jpg"
  className="screenshot"
  alt="GraphOS Studio Audit Log"
  width="400"
/>
...
If your audit log includes an action type that is not listed below and you have questions about it, please contact [support@apollographql.com](mailto:support@apollographql.com).
