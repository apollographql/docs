...
<EnterpriseFeature
  text={
    "**This feature is available only with an [Enterprise plan](https://www.apollographql.com/pricing/).** If your organization _doesn't_ currently have an Enterprise plan, you can test out this functionality by signing up for a free [Enterprise trial](./plans/#enterprise-trials)."
  }
/>
