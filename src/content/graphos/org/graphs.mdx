...
> [Get started with a cloud supergraph.](../getting-started/)
...
> [Get started with a self-hosted supergraph.](../self-hosted/)
...
**To create a cloud supergraph,** see the [GraphOS quickstart](../getting-started/).

**To create a _non_-cloud graph** (i.e., a self-hosted supergraph or a monograph), see the instructions for your organization's [plan type](./plans/):
