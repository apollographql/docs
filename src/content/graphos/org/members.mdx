...
> ⚠️ **Notes**  
> - If your organization uses an identity provider (IdP) for single sign-on (SSO), before inviting an individual member, verify that the member can log in to Studio via your SSO provider.
