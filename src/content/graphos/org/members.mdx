...
The table below shows _default_ schema proposal settings. You can [configure which roles can create, edit, and approve proposals](../delivery/configure-proposals#configure-permissions-and-approvals).
