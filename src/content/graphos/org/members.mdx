...
Any invitation links issued before SSO setup will be automatically revoked once SSO is enabled.
...
If an invite link becomes compromised, an admin can revoke it from the **Settings > Invite links** section.
