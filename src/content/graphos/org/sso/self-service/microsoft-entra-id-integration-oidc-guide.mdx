...
If you are on a Dedicated or Enterprise plan and setting up SSO for the first time, please refer to [these instructions](../microsoft-entra-id-integration-oidc-guide).
...
1. Create an app registration for GraphOS in Entra ID.
