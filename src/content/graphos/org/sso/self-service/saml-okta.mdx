...
The GraphOS Studio setup wizard populates your SSO metadata based on the URL you entered in the last step. In this step, you verify the values are correct.
