...
Self-service single sign-on (SSO) is available only for organizations with Dedicated and Enterprise plans who set up SSO with PingOne and need to migrate.
