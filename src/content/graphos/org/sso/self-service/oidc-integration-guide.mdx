...
If you are on a Dedicated or Enterprise plan and setting up SSO for the first time, please refer to [these instructions](../oidc-integration-guide).
...
1. Create an application for GraphOS in your IdP.
1. Configure OIDC to work with GraphOS.
