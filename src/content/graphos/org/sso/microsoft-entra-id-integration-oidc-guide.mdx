...
9. Copy and open the **OpenID Connect metadata document** URL in a new browser tab. Find the **`issuer`** value. It should be formatted like `https://login.microsoftonline.com/unique-value/vx.x`. Copy and paste this URL into into the **Issuer** field in the setup wizard.
10. Click **Continue**.
...
<SSOLegacyUsers idp="Entra ID" appType="app registration" />
