...
If you previously configured SSO using the instructions below and want to use [multi-organization SSO](./multi-organization) you need to recreate your SSO connection with the [updated instructions](#configuration).
