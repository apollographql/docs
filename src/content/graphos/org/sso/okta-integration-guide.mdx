...
8. Back in the setup wizard in GraphOS Studio, select that your IdP requires signing an AuthNRequest. Then click **Continue**.
...
- You can find your app integration's **Entity ID** in the **Sign On** tab. Scroll down to the **SAML 2.0** section and look for a field labeled **Issuer**. This field contains the Entity ID. It has a URL format: `http://www.okta.com/<unique-id>`.
- You can find the **SSO URL** in the same **SAML 2.0** section in a field labeled **Sign on URL**.
