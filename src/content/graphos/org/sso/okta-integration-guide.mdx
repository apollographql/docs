...
8. Back in the setup wizard in GraphOS Studio, click **Continue** to share SSO metadata with Apollo.
...
1. The GraphOS Studio setup wizard populates your SSO metadata based on the **Metadata URL** you entered in the last step. Verify the values are correct and click **Continue**.
2. On the **Enable SSO** step of the wizard, click **Continue** to enable SSO in GraphOS Studio.
