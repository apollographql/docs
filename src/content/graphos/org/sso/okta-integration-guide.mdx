...
### Step 1. Share you SSO details

1. Go to [GraphOS Studio](https://studio.apollographql.com?referrer=docs-content). Open the **Settings** page from the top navigation. Open the **Org management** tab from the left sidebar and click **Enable SSO**. A setup wizard appears.
...
1. Once you get to **Step 2: Your IdP and Apollo** in the wizard, open your Okta Administrator Dashboard in a separate browser tab.
...
8. Back in the setup wizard in GraphOS Studio, click **Continue**.
...
The GraphOS Studio setup wizard populates your SSO metadata based on the **Metadata URL** you entered in the last step. Verify the values are correct and click **Continue**.

### Step 5. Enable SSO

On the **Enable SSO** step of the wizard, click the **Enable SSO** button to finalize setup.
Once your SSO setup is finalized, you need to [assign users](#assign-users-in-okta) to your custom app in Okta for them to have access.
