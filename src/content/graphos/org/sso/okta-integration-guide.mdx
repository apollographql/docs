...
This guide walks through configuring Okta as your GraphOS organization's identity provider (IdP) for SSO. Once you've set up your integration, you need to assign users to it in Okta so they can access GraphOS Studio via SSO.
