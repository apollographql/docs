...
Enabling SSO ends any active login sessions and removes any non-SSO users from your organization.
You must [assign users](#assign-users-in-okta) to your custom app in Okta to give them access.
