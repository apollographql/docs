...
2. In your Okta Administrator Dashboard, go to the **Applications** view and click **Create App Integration**.
   ...
   To use the latest version of Apollo's SSO, ensure you _create a custom app integration_ in Okta rather than usie the GraphOS app in the Okta Application Network.
...
8. In the setup wizard in GraphOS Studio, select that your IdP requires signing an AuthNRequest. Then click **Continue**.
