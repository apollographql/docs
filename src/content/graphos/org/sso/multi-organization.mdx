---
title: Use multi-organization SSO
...
When in [GA](/resources/product-launch-stages#general-availability), multi-organization SSO will also support service-provider-initiated (SP-initiated) SSO.
