---
title: Setting up Apollo SSO with Microsoft Entra ID
---
...
This guide walks through configuring Microsoft Entra ID (formerly known as Azure Active Directory) as your Apollo organization's identity provider (IdP) for single sign-on (SSO).
...
### Step 2. Retrieve your endpoint URL and client ID
...
### Step 5. Integrate with Azure AD
...
### Step 6. Configure the OIDC application
