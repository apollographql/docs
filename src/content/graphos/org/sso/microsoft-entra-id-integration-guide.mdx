---
title: Set up Apollo SSO with Microsoft Entra ID
---
...
### Step 2. Retrieve your endpoint URL, client ID, and client secret
...
4. In the **Certificates & secrets** section of your app registration, click **+ New client secret** and create a new secret.
5. Copy and paste the secret's **Value** to the same text file you created earlier.
6.
...
2. Also in the **API Permissions** section, select **Grant admin consent** next to the **+ Add a permission** button. Doing this ensures that your users don't need to grant consent during SSO.
