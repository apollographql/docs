...
1. **Save** your changes.
1. In the **Overview** section of your app registration, select **Endpoints** from the top menu. Copy and paste the **Federation metadata document** URL into the same local text file for use in the next step.
