...
Send your Apollo contact the **pp Federation Metadata URL** you previously copied. Your Apollo contact will complete your SSO setup.

## Assign users in Entra ID

Once your Apollo application is set up in Entra ID, you need to assign users to it so they can access GraphOS. You can assign individual users or groups from the **User and groups** page of your Apollo application in Entra ID.
