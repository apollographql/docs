...
1. Create an application for Apollo GraphOS in your IdP.
1. Configure OIDC to work with Apollo.
1. Enable SSO in GraphOS Studio.

The SSO setup wizard in GraphOS Studio guides you through these steps.
Once you enable SSO, you must assign users to your application in your IdP to give them access to GraphOS Studio.
