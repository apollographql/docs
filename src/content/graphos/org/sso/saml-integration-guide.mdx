...
1. Send your Apollo contact the following:

   - The organization name you are setting up SSO for
   - Your IdP SAML XML metadata file. If you can't send this file, send one of the following instead:

     - IdP entity ID
     - IdP single sign-on URL / SSO URL
     - IdP x509 certificate

2. Your Apollo contact will respond with a URL to download Apollo's service provider (SP) SAML XML metadata file as well as the following values:
   ...
   These values differ for each organization. If setting up SSO for multiple organizations, ensure you use different values.
...
4. If your IdP permits it, upload the Apollo-provided SP SAML XML metadata file. Otherwise, open the XML metadata file, view the SAML configuration settings, and manually enter them in your IdP.
...
7. Assign users to your new Apollo GraphOS application. Reach out to your SSO or Identity & Access Management team for help assigning the relevant groups and users.
