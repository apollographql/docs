...
3. If your IdP permits it, upload the SP SAML XML metadata file provided by the GraphOS setup wizardz. Otherwise, open the XML metadata file, view the SAML metadata values, and manually enter them in your IdP.
