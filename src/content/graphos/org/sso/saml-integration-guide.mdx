...
1. Send your Apollo contact your IdP SAML XML metadata file.
...
4. If your IdP permits it, upload the Apollo-provided SP SAML XML metadata file.
   Otherwise, [To-do: give instructions for each individual field, maybe how they map to the fields in the XML file, or we could send them like a JSON or other format with this information]
...
6. Assign users to the Apollo GraphOS application.
