...
Unfortunately, we are unable to offer an in-place migration. You will need to create a new variant on your graph, or a new graph entirely. Once you create this new variant or graph, you will receive a new graph ref and endpoint URL which you can redirect your client traffic to. You can't reuse an existing graph ref.
