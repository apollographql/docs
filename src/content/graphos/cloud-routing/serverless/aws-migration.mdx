...
- In [GraphOS Studio](https://studio.apollographql.com?referrer=docs-content), the **Cloud Router Details** section on the **Overview** page shows **ord - US (Chicago)** as the **Region** for your graph

  <img
    className="screenshot"
    alt="Cloud router region showing ord - US (Chicago) in GraphOS Studio"
    src="../../img/cloud-routing/cloud-router-region-ord.jpg"
    width="300"
  />

If a graph has a cloud router running on Fly.io, its **Overview** page also shows a migration banner.
...
<img
  ...
  src="../../img/cloud-routing/cloud-router-details.jpg"
  width="300"
/>
...
## Serverless on AWS for Dedicated Customers
Dedicated customers who are running Serverless tier variants for their non production environments need to migrate their Fly cloud routers to AWS. This cannot be accmplished from the Studio UI. Instead, you can publish a new variant or graph from [rover](https://www.apollographql.com/docs/rover/commands/subgraphs#publishing-a-subgraph-schema-to-graphos). Any variants created via rover default to Serverless (even if you're on the Dedicated plan).
