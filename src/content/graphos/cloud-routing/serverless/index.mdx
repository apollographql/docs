...
Serverless is moving to AWS. If you initialized your Serverless cloud router before May 21, 2024, you may need to migrate to keep your cloud router running. [Learn more](./aws-migration).
