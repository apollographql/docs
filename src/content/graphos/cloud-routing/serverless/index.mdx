...
If a cloud router has been sleeping for 30 days, it will be automatically deleted. This does not delete your variant from GraphOS Studio, but it does spin down the infrastructure powering your cloud router. Deleting resets both your cloud router config and secrets.

[todo: screenshot of will deleete soon banner]
