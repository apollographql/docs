...
Serverless is moving to AWS. If you initialized your Serverless cloud router before May 21, 2024, you need to migrate to keep your cloud router running. [Learn more](./aws-migration).
...
Because of these limitations, certain workloads might require you to upgrade to Dedicated. <TrackableLink href="https://www.apollographql.com/contact-sales?type=dedicated&referrer=docs" eventName="content_contact_cloud">Contact Sales</TrackableLink> for a free trial.
...
- Apollo will email you when a Serverless cloud router is nearing this 30-day limit.
