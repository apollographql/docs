...
## Timeline
Serverless variants created on or after May 7, 2024 run on AWS and no action is required.

Serverless variants created before May 7, 2024 need to be manually migrated from Fly to AWS from within GraphOS Studio.
...
## FAQ
### Can I still use cloud routers running on Fly.io?
