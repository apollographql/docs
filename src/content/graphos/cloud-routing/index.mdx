...
They are not available to organizations with an Enterprise plan or a legacy Free or Team plan.
...
Cloud routing on the [Dedicated](./dedicated) plan has a wider variety of options. <TrackableLink href="https://www.apollographql.com/contact-sales?type=dedicated&referrer=docs" eventName="content_contact_cloud">Get in touch</TrackableLink> to learn more.
