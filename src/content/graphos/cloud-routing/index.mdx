...
Some legacy Serverless cloud routers are hosted in Chicago, Illinois. [Learn more.](./serverless/aws-migration/#change-summary)
If your Serverless graph's **Overview** page doesn't show **AWS-us-east-1** under the graph ref, then it is hosted in Chicago.
