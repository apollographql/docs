...
GCUs run on AWS in the region of your choice.
...
Requests like this decrease throughput capacity because they require additional compute resources to execute.
Factor in additional GCUs into your throughput calculation if your supergraph receives complex queries or returns large responses.
