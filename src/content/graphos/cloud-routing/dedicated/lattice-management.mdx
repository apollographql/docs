...
You can also use the **Metrics** tab to get a quick overview of traffic flowing to your private subgraphs.
...
- The Lattice service's configured authorization policy allows traffic only from Apollo AWS accounts. (This is the authorization policy you configured in step 6 [when creating your Lattice service](#step-2-create-a-lattice-service).)
