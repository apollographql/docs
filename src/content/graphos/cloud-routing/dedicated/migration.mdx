...
See the [GraphOS Router documentation](/router/) for a full list of features.

## Migration

Once your implementation is ready to run on the router, including customizations, you can follow the [Dedicated quickstart](./quickstart) to get started.
