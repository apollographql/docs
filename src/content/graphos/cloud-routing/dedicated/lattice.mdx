...
This guide shows how to create Lattice services and share them with GraphOS. This configuration lets your GraphOS cloud routers securly communicate with your private subgraphs.
...
- For security purposes, we recommend you continue to the next step immediately after creating the resource share. If you see that the resource share was **Accepted** or **Failed** in the AWS console and you didn't follow [step 4](#step-4-link-resource-share) of this guide, follow the steps to [remove access to private subgraphs](./lattice-management#remove-access) and restart this step.
...
The [Lattice management page](./lattice-management) provides information on monitoring and how to further restrict and remove access to subgraphs.
See the [troubleshooting guide](./lattice-troubleshooting) if you're having issues with your Lattice setup.