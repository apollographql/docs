...
2. Create one or more Lattice service.
...
- You can use Amazon VPC Lattice in your organization for other uses than routing GraphOS traffic to subgraphs. You can associate a Lattice service with multiple service networks and GraphOS associates your Lattice services with its own service network.
...
Congratulations! You've created an Amazon VPC Lattice target group. Repeat this process for each resource you want to share with GraphOS.
