...
<img
  ...
  src="../../img/cloud-dedicated/create-new-graph.jpg"
/>
...
<img
  ...
  src="../../img/cloud-dedicated/add-a-subgraph.jpg"
/>
...
<img
  ...
  src="../../img/router/cloud-router-configuration.jpg"
/>
...
You can find your endpoint URL on the **Overview** page under the graph's graph ref in GraphOS Studio.

<img
  className="screenshot"
  alt="A cloud router's endpoint displayed on the Cloud Router page in GraphOS Studio"
  src="../../img/router/router-endpoint.jpg"
/>
