...
### Apollo Router
Since Apollo Router [v1.43.1](https://github.com/apollographql/router/releases/tag/v1.43.1), the operation signature is added to the context in the key `apollo_operation_signature`. You can read the context in either Rhai scripts or a coprocessor, or using the logging features of Router, you can log context values as [trace attributes](/docs/router/configuration/telemetry/instrumentation/selectors).
