...
Enterprise organizations using a self-hosted GraphOS Router can enable enhanced operation signature generation.
Enhanced operation signatures include input object types and field aliases.
...
Enterprise organizations using a self-hosted GraphOS Router can enable enhanced operation signature generation.
Enhanced operation signatures include the form of the input object type, while still redacting any of the actual values.
See the [router configuration page](/router/configuration/overview#enhanced-operation-signature-normalization) to learn more.
...
Enterprise organizations using a self-hosted GraphOS Router can enable enhanced operation signature generation that does not remove field aliases.
See the [router configuration page](/router/configuration/overview#enhanced-operation-signature-normalization) to learn more.
...
Since router [v1.49.0](https://github.com/apollographql/router/releases/tag/v1.49.0), enterprise organizations running a self-hosted router can enable enhanced operation signature generation that includes include input object types and field aliases.
See the [router configuration page](/router/configuration/overview#enhanced-operation-signature-normalization) to learn more.
