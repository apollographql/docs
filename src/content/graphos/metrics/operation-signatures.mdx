...
Organizations using the Apollo Router can enable enhanced operation signature generation.
...
Organizations using the Apollo Router can enable enhanced operation signature generation that does not remove field aliases.
See the [router configuration page](/router/configuration/overview#enhanced-operation-signature-normalization) to learn more.
