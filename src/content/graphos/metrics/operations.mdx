...
_Federated subscriptions_ are subscriptions that rely on data from multiple subgraphs. Federated subscriptions have an additional step after step 3: the router must fetch data from any other necessary subgraphs before publishing an aggregated response to clients.
...
<img
  src="../img/insights/operation-details.jpg"
  className="screenshot"
  alt="The Insights page in GraphOS Studio"
  width="600"
/>
...
<img
  src="../img/insights/traces-tab.jpg"
  className="screenshot"
