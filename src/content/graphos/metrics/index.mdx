...
<SummitCallout topic="supergraph observability">

Explore observability best practices in the GraphQL Summit Workshop: [Observability for the supergraph: Best practices for graph-native telemetry](https://reg.summit.graphql.com/flow/apollo/summit24/AttendeePortal/page/catalog/session/1712947030008001KyII).
