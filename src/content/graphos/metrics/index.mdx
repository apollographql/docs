...
description: Learn how to monitor and optimize your graph's usage and performance with raw metrics, insights, and alerts with Apollo GraphOS.
---
...
requires an [Enterprise _or_ legacy Team plan](../orgs/plans).

If your organization
doesn't currently have an Enterprise plan, you can test out this functionality by
signing up for a free [Enterprise trial](https://studio.apollographql.com/signup?type=enterprise-trial&referrer=docs-content).
