...
<EnterpriseFeature
  text={`Reporting metrics from [Apollo Server](/apollo-server) or a [monograph](../graphs/#monographs) requires an [Enterprise or legacy Team plan](../orgs/plans).\n\nThe following require an [Enterprise plan](https://www.apollographql.com/pricing/):
- Connecting a self-hosted router to GraphOS
- Forwarding metrics to Datadog
\nIf your organization doesn't currently have an Enterprise plan, you can test out this functionality by signing up for a free [Enterprise trial](../enterprise/#enterprise-trial)
`}
/>
