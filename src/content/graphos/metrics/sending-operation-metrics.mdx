...
To report metrics for requests, your GraphQL server must run Apollo Server 3.6 or later.
...
If you do this, field execution statistics do not appear on the Insights page.
...
For example, if you pass `0.01`, your server enables field-level execution for approximately 1% of requests, and every observed field execution is counted as 100 executions on the Insights page. (The actual observed execution count is available in a tooltip in the table.)
