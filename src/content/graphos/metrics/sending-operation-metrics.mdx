...
> Reporting metrics from a [monograph](../graphs/#monographs), [Apollo Server](/apollo-server/), or a [self-hosted supergraph](../graphs/#self-hosted-supergraphs) requires an [Enterprise plan](../org/plans/).
