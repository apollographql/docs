...
We strongly encourage developers to contact Apollo support at [support@apollographql.com](mailto:support@apollographql.com) to discuss their use case before building their own reporting agent using this module.
