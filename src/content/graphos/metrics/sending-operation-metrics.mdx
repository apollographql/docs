...
How you report operation metrics to GraphOS depends on whether you're [using the GraphOS Router or Apollo Server](#from-the-apollo-router-or-apollo-server) or whether you're [using a third-party server](#from-a-third-party-server-advanced).

### From the GraphOS Router or Apollo Server
