...
Notifications indicate whether the build succeeded. Successful build notifications include a temporary URL to the new supergraph schema if so.
...
Whether ot not the build succeeded
