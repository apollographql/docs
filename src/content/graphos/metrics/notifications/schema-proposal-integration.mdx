...
3. Optionally, enter a **Secret Token**.
  ...
  If you enter a token, each notification HTTP request includes an `x-apollo-signature` header whose value is a [Hash Message Authentication Code (HMAC)](https://en.wikipedia.org/wiki/HMAC) generated using the token, the SHA256 hash function, and the request body as the message.
  ...
  **Hash function**: SHA256
  ...
  The `x-apollo-header` value would be `sha256=25e21615f12995b82833d3dfabcb207dfb16e97226b5a0696b24624b1031f1ca`.
  </ExpansionPanel>
