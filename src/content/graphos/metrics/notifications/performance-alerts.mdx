...
If you want to receive notifications via both Slack and PagerDuty, you need to repeat these setup steps for both.
...
You can send performance alerts via Slack, PagerDuty, or both.
