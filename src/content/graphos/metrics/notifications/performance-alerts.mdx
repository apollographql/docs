...
description: Configure alerts to receive notifications in Slack or PagerDuty instance when specific request and error metrics for your GraphQL API surpass defined thresholds.
---
