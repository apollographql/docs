...
- The collapsible left sidebar, where you can search, filter, and sort operations and fields
  - The types of fields you can access insights for [depend on your plan](#field-usage-metrics-availability)
- The main insights view on the right
  - This view displays [overall operations metrics](./operations#operation-metrics) by default, or field information and usage metrics for a single field once you select it from the left sidebar
...
<img
  src="../img/insights/field-filters.jpg"
  class="screenshot"
  alt="Field Insights page left sidebar"
  width="300"
/>

All organizations can view **object fields**, but only organizations with an Enterprise plan can view usage metrics for **input fields** and **enum values**.
...
To access input and enum field metrics you must use the GraphOS Router to [report metrics](./sending-operation-metrics) and configure [extended reference reporting](/router/configuration/overview/#extended-reference-reporting) in your router.

<Note>

Field [execution metrics](#field-requests-and-executions) are only available for standard object fields, not input object fields or enum values.
...
<img
  src="../img/insights/field-insights.jpg"
  class="screenshot"
...
Execution metrics are only available for [standard object fields](#object-fields), not [input object fields or enum values](#input-fields-and-enum-values).
...
<img
  src="../img/insights/requests-executions.jpg"
  class="screenshot"
