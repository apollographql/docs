...
subtitle: Understand field usage metrics including which clients request which fields and how often
description: Explore field usage metrics in Apollo GraphOS Studio. Analyze field requests and executions to understand your graph's performance.
---
