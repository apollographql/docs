...
```shell {1}
rover subgraph publish graph-id@variant-name \
...
In the next article, we'll cover some of the most common and important actions to perform on your supergraph, including:
