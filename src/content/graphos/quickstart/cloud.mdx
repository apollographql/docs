...
> **Note:** Organizations can create up to 20 separate cloud supergraphs. Please do reach out if you believe your org may need more than that, we would be very interested to hear from you and understand your use case.
...
From your **Supergraphs** tab, click your graph's `main` variant. This opens the variant's README page.
