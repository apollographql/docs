---
title: Organizational Structure to support a Supergraph
id: TN0041
description: How to best organise your engineering teams when delivering a Supergraph
tags: [federation, subgraphs, best-practices, organisation]
---

When setting out to deliver a federated Supergraph at scale, one of the biggest hurdles organisations face is often not the technical understanding, but rather adopting an appropriate organisational structure to support it. There are a number of ways in which organisations have adapted to best enable the delivery of the Supergraph, which we'll look to discuss here in the context of each of the different stages of delivery. However, it is worth first re-addressing the primary drivers and value of adopting a federated graph to help provide context for the organisational decisions proposed and how they fit into the bigger picture.
...
Ultimately organisational structure is critical to the success of the graph within an enterprise. Below are some of the key takeaways for setting up your teams for success:
...
- Time and focus is also put into evangelising the graph outside of the engineering teams, to help drive awareness and understanding across the wider business, ultimately helping to expand the graph across the organisation to help drive increased value to both the business itself and the end users.

It is of course worth noting that every business, implementation, industry and use case differs and brings its own specific requirements to the table. However, if the engineering teams are setup in such a way that empowers them to work quickly and autonomously whilst leveraging tooling that ensure consistency and best practice across the platform, you will be well on your way for the successful implementation of a Supergraph at scale.
