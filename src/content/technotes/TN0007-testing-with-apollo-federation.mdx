...
Testing in GraphQL may seem like it can involve more steps, but that is because your GraphQL architecture can involve many areas of your techstack, from your frontend with Apollo Client to a backend with Apollo Server, or your infrastucture with your Apollo Router to the invidudual subgraphs in your supergraph. In practice, all of these areas should be properly tested the same way if we were using any other API technology, but often the testing across boundries like teams or applications can involve some new steps. By the end of this guide you should have:
...
To see more examples on how to test these operations, see [`Query._entities`](/federation/subgraphs#query_entities).
