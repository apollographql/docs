...
description: Use this checklist—covering the GraphOS Router, subgraphs, and clients—to identify potential gaps before your graph handles production traffic.
...
- Optionally, enable any [other features](/router/enterprise-features/) deemed critical for your deployment of GraphOS Router
