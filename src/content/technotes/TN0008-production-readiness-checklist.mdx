...
- Ensure that your [clients identify themselves](/studio/client-awareness/) by name and version.
...
- If your [subgraph servers are listed as compatible with `ftv1`](/federation/other-servers), ensure that you've enabled [federated traces](/federation/metrics/), and that you can view operation metrics as expected in Apollo Studio.
