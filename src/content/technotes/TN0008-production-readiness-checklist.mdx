...
description: We recommend that you read through this checklist and identify critical features for your team before your supergraph begins handling production traffic.
...
- Configure additional [tracing, metrics, and logging](/router/configuration/telemetry/overview) through OpenTelemetry or Prometheous
