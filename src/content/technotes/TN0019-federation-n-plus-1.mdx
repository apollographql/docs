...
description: GraphQL developers quickly encounter the infamous "N+1 query problem" with operations that return a list. The article talks about how N+1 is handled in a federated graph.
