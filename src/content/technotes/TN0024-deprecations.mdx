...
Specifically, the [**Clients & Operations** table](/graphos/metrics/field-usage#field-details) on the Insights page in [GraphOS Studio](/graphos/) can provide insight into what clients might still be using the deprecated fields so appropriate follow-ups can be actioned.
