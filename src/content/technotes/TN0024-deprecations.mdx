...
Specifically, the _Requested by operations in the last day_ column in the Insights page in [GraphOS Studio](/graphos/) can provide insight into what clients might still be using the deprecated fields so appropriate follow-ups can be actioned.
