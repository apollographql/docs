...
## Consider moving to the Apollo Router Core

The Apollo Router Core is a high-throughput, low-latency GraphQL federation gateway written in Rust. Its performance and consistency significantly exceed any Node.js-based gateway.

[Migrating to Apollo Router Core from `@apollo/gateway`](/router/migrating-from-gateway)
