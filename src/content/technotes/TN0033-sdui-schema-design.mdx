...
These patterns provide examples of server-driven UI (SDUI) and how you can structure your graph's schema to encode and represent UI elements. Clients can then use platform-specific rendering engines to interpret the schema and generate UI components.
