...
description: Client apps need to keep their schemas up-to-date whenever changes are made to the supergraph. In order to facilitate this Apollo has some specific recommendations.
