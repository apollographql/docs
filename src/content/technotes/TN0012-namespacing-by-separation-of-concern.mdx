...
As pointed out by Benjie from the technical steering committee, while the above approach does work in practice, it is [currently unsupported by the spec](https://benjie.dev/graphql/nested-mutations).

However, at this time, there is currently no alternative, but there has been a [proposal for GraphQL Namespaces](https://github.com/graphql/graphql-spec/issues/163) since 2016.
