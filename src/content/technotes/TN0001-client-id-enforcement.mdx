...
If you do change the identifying headers, also update the [Usage Reporting Plugin](/graphos/metrics/client-awareness/#advanced-apollo-server-configuration) to use the new headers so that the proper client info is also sent to Studio.
