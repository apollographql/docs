...
description: In some situations you still might want to designate an "owner" of an entity and make "entity extension" a first-class concept in your supergraph.
...
One example is the ability assert which subgraph is responsible for documenting an entity. If two subgraphs add different descriptions to a type, composition selects _one_ of those descriptions and emits a hint informing you of the inconsistency:
...
You can add an `@owner` directive to your supergraph using the [`@composeDirective`](/federation/federated-types/federated-directives#composedirective) functionality introduced in Federation 2.2.
...
<ExpansionPanel title="Click to view the supergraph schema">
