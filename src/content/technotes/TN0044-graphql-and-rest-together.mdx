...
- The _Presentation_ layer is where customers interact with products, experiences, and API marketplaces.
- The _Application_ layer is where services and business logic live and through which _Presentation_ apps access data.
- The _Data_ layer stores data about your company, customers, products, etc.
