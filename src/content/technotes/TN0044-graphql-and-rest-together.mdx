...
Any effort investment into an API should pay dividends. An investment should have a positive impact to multiple use cases now as well as many use cases in the future.
