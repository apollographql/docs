...
description: When using the Apollo Router as the entry point to your federated supergraph, you can combine strategies to handle a number of authentication requirements and practice "defense-in-depth".
