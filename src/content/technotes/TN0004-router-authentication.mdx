...
summary: When using the Apollo Router as the entry point to your federated supergraph, uou can combine strategies to handle a number of authentication requirements and practice "defense-in-depth".
