...
- A marketing campaign or viral social media post drives high traffic to an application in a short period.- A newly deployed feature introduces more load on the graph than expected.
...
hen adding overload protection to a supergraph, a reasonable question is, "Do I add protection to my gateway/router, or to my individual subgraphs?" The short answer is "both":
