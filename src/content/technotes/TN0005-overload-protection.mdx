...
## Does this belong on the router or subgraph?

The short answer is both, for different reasons. The router to allow to protect overall avaibility of the graph. A subgraph should have overload protection to reduce the error rates of quries that include data from that spesfic subgraph.
