...
To further protect against overloading of your graph and system, you may want to consider [limiting query depth](/technotes/TN0021-graph-security/#limit-query-depth) and [rate limiting](/technotes/TN0021-graph-security/#use-rate-limiting-as-needed).