...
subtitle: Incrementally adopt SDUI to simplify client logic
description: In server-driven UI (SDUI), the client's goal is to handle pixels, not data. The client should simply take what the API provides and render it in the proper location.
