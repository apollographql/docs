...
subtitle: Enable teams to work in parallel without blocking each other
description: Mock parts of your supergraph as you develop both your subgraphs and clients to enable teams to work in parallel without blocking each other.
...
As your organization builds out its supergraph, you might discover that your client teams are often waiting on subgraph owners to make agreed-upon changes to their schemas. During this time, you can _mock_ parts of your supergraph as you develop both your clients and subgraphs, enabling teams to work in parallel without blocking each other.
...
To use this sample, you need to [publish your schema to Apollo GraphOS](/graphos/delivery/publishing-schemas/). For details on the benefits of publishing to GraphOS, [see below](#why-use-graphos-for-a-mocked-server).
...
You'll need to [publish your schema to GraphOS](/graphos/delivery/publishing-schemas/) to use this sample. For details on the benefits of publishing to GraphOS, [see below](#why-use-graphos-for-a-mocked-server).
...
- GraphOS Studio provides a centralized view of your schema, along with a [mocked view of the schema](/graphos/explorer/additional-features/#mocked-responses).
