...
description: Federation applies orchestration capabilities to mutation fields (and their selection sets), but managing state changes across distributed systems typically involves additional requirements.
...
Read more on [contracts usage patterns in this technote](/technotes/TN0014-contracts-patterns/).
