...
A [`__resolveReference`](https://www.apollographql.com/docs/federation/entities/#2-define-a-reference-resolver) warrants a specific call out in a federated architecture. A `__resolveReference` is how subgraphs communicate, making testing this code very important.
