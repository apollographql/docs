...
It's worth noting that Facebook designed connections for their Newsfeed feature with these features:
...
Apollo recommends always using a wrapper type for lists.
