...
Consider the ["Zero, One, Infinity" rule](https://en.wikipedia.org/wiki/Zerooneinfinity_rule)—can you definitively assert that your list will never require pagination or other metadata about the relationship?
