...
subtitle: Best practices for demand oriented schema design
description: Support GraphQL client applications that consume data from our federated graph by designing schemas in an abstract, demand-oriented way.
