...
id: TN0003
description: Learn how to convert your operation traces into aggregated metrics without requiring manual instrumentation in order to provide a view of your graph's broader performance.
...
To send traces from the Apollo Router to OpenTelemetry Collector, see [this article](/router/configuration/telemetry/exporters/tracing/otlp).
