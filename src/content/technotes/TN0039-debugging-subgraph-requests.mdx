---
title: Debugging subgraph requests from the Apollo Router or @apollo/gateway
subtitle: Log query plans and subgraph calls to help debug problematic queries
description: Log query plans and subgraph calls with the Apollo Router and @apollo/gateway to help debug problematic queries.
