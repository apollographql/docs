...
As your graph grows, you may need to debug a problematic query for one reason or another. The router and `@apollo/gateway` both serve as an entry point into your federated graph and offer ways to debug requests.
