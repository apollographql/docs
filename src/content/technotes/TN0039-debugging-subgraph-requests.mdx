...
The above snippet creates a new class called `DebugDataSource` to log out the operation name and body using the `willSendRequest` hookwhich is called before execution.
