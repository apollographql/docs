...
description: One of the advantages of using GraphQL is that it provides an abstraction between service consumers and the teams maintaining the backend services.
...
GraphQL is a powerful tool for abstracting away the complexities of backend services from front-end consumers. It can shield consumers from major changes to those services while reducing the impact of those changes. Ultimately, it provides choice and control to consumers without negatively impacting backend services.
