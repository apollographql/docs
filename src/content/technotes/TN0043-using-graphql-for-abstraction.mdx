...
- [How to Move from BFFs to GraphQL Federation <FiExternalLink style={{display: 'inline'}} />](https://www.xolv.io/blog/articles/how-to-move-from-bffs-to-graphql-federation/)