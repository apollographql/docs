...
connections proliferates, and a change to any of the backing APIs/Components has major implications. 
...
Scaling this up to an enterprise level, this could potentially eliminate hundreds of updates, deployments, 
